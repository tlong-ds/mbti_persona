...
def display_about():#
    set_background()
    st.write("""Understanding one's personality and the ways it influences interactions with the world is invaluable for personal development, professional growth, and relationship building. This personality test application provides users with an opportunity for insightful self-reflection through a structured and engaging approach. Each question is carefully crafted to reveal key personality traits, strengths, and preferences, enabling users to gain a clearer perspective on themselves and their unique qualities. With these insights, individuals are empowered to make informed decisions that enhance their personal and professional lives. Embark on this journey of self-discovery today and uncover a deeper understanding of your own character.""")
...
# Call the function to display the page
    ...
    st.write("""
    - **Email**: Nguyendangminh3112@gmai.com
    - **Phone**: +84 868827131
